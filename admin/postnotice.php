...
<body class="hold-transition skin-green sidebar-mini">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <?php 
                                        // Check if 'resume' key exists and is not empty
                                        if (isset($row['resume']) && $row['resume'] != '') { ?>
                                            <td><a href="../uploads/resume/<?php echo htmlspecialchars($row['resume']); ?>" download="<?php echo 'Notice'; ?>"><i class="fa fa-file"></i></a></td>
                                        <?php } else { ?>
  ...
  height: 50px; position:absolute; background-color:#1f0a0a; color:white">
        <div class="text-center">
            <strong>Copyright &copy; 2025 Career Catalyst</strong> All rights
            reserved.
        </div>
    </footer>
